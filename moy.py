...
# This file was *autogenerated* from the file moy.sage
...
class X():
    ...
    def __init__(self, elist):
        ...
        assert elist[_sage_const_0 ][_sage_const_1 ] == elist[_sage_const_2 ][_sage_const_1 ] and elist[_sage_const_1 ][_sage_const_1 ] == elist[_sage_const_3 ][_sage_const_1 ]
        self.crossing = list(elist)
    
    @property
    def i(self):
        return self.crossing[_sage_const_0 ]
    
    @property
    def j(self):
        return self.crossing[_sage_const_1 ]
    
    @property
    def k(self):
        return self.crossing[_sage_const_2 ]
    
    @property
    def l(self):
        return self.crossing[_sage_const_3 ]
    ...
    @property
    def seg_ids(self):
        return [s[_sage_const_0 ] for s in self.crossing]
    
    
    @property
    def sign(self):
        if self.crossing[_sage_const_1 ][_sage_const_0 ] - self.crossing[_sage_const_3 ][_sage_const_0 ] == _sage_const_1  or self.crossing[_sage_const_3 ][_sage_const_0 ] - self.crossing[_sage_const_1 ][_sage_const_0 ] > _sage_const_1 :
            return _sage_const_1 
        elif self.crossing[_sage_const_3 ][_sage_const_0 ] - self.crossing[_sage_const_1 ][_sage_const_0 ] == _sage_const_1  or self.crossing[_sage_const_1 ][_sage_const_0 ] - self.crossing[_sage_const_3 ][_sage_const_0 ] > _sage_const_1 :
            return -_sage_const_1 
        
    def __repr__(self):
        return 'Crossing '+str([i[_sage_const_0 ] for i in self.crossing])
...
class V():
    ...
    @property
    def in_seg_ids(self):
        return [s[_sage_const_0 ] for s in self.incoming_edges]
    
    @property
    def out_seg_ids(self):
        return [s[_sage_const_0 ] for s in self.outgoing_edges]
    ...
    def __repr__(self):
        return 'Vertex with ' + str([i[_sage_const_0 ] for i in self.incoming_edges]) \
             + ' incoming and '+ str([i[_sage_const_0 ] for i in self.outgoing_edges]) + ' outgoing.'


class MOY():
    def __init__(self, xvs, ):
        self.t = var('t')
        self.abs_delta = _sage_const_0 
        ...
        for x in self.xs:
            self._union(self.segment_parents, x.i[_sage_const_0 ], x.k[_sage_const_0 ])
            self._union(self.segment_parents, x.j[_sage_const_0 ], x.l[_sage_const_0 ])
        ...
        for x in self.xs:
            for s in x.crossing:
                if s[_sage_const_0 ] not in self.seg_to_col:
                    self.seg_to_col[s[_sage_const_0 ]] = s[_sage_const_1 ]
        ...
        self.edge_to_col = {e:self.seg_to_col[self.edge_to_seg[e][_sage_const_0 ]] for e in self.edges}
        ...
        self.n_regions = self.n_crossings + _sage_const_2 
        ...
        reg_c = [i for i in range(_sage_const_2 *self.n_seg)]
        for x in self.xs:
            if x.sign == _sage_const_1 :
                # 2*x.i -- left; 2*x.i + 1 -- right
                self._union(reg_c, _sage_const_2 *x.i[_sage_const_0 ] + _sage_const_1 , _sage_const_2 *x.j[_sage_const_0 ] + _sage_const_1 )
                self._union(reg_c, _sage_const_2 *x.j[_sage_const_0 ],     _sage_const_2 *x.k[_sage_const_0 ] + _sage_const_1 )
                self._union(reg_c, _sage_const_2 *x.k[_sage_const_0 ],     _sage_const_2 *x.l[_sage_const_0 ])
                self._union(reg_c, _sage_const_2 *x.l[_sage_const_0 ] + _sage_const_1 , _sage_const_2 *x.i[_sage_const_0 ])
            elif x.sign == -_sage_const_1 :
                self._union(reg_c, _sage_const_2 *x.i[_sage_const_0 ] + _sage_const_1 , _sage_const_2 *x.j[_sage_const_0 ])
                self._union(reg_c, _sage_const_2 *x.j[_sage_const_0 ] + _sage_const_1 , _sage_const_2 *x.k[_sage_const_0 ] + _sage_const_1 )
                self._union(reg_c, _sage_const_2 *x.k[_sage_const_0 ],     _sage_const_2 *x.l[_sage_const_0 ] + _sage_const_1 )
                self._union(reg_c, _sage_const_2 *x.l[_sage_const_0 ],     _sage_const_2 *x.i[_sage_const_0 ])
            else: 
                print('something is really wrong!')
                
        for v in self.vs:
            self._union(reg_c, _sage_const_2 *v.incoming[_sage_const_0 ][_sage_const_0 ], _sage_const_2 *v.outgoing[-_sage_const_1 ][_sage_const_0 ])
            self._union(reg_c, _sage_const_2 *v.incoming[-_sage_const_1 ][_sage_const_0 ]+_sage_const_1 , _sage_const_2 *v.outgoing[_sage_const_0 ][_sage_const_0 ]+_sage_const_1 )
            if v.n_incoming > _sage_const_1 :
                for i in range(v.n_incoming - _sage_const_1 ):
                    self._union(reg_c, _sage_const_2 *v.incoming[i][_sage_const_0 ]+_sage_const_1 , _sage_const_2 *v.incoming[i+_sage_const_1 ][_sage_const_0 ])
            if v.n_outgoing > _sage_const_1 :
                for i in range(v.n_outgoing - _sage_const_1 ):
                    self._union(reg_c, _sage_const_2 *v.outgoing[i][_sage_const_0 ], _sage_const_2 *v.outgoing[i+_sage_const_1 ][_sage_const_0 ]+ _sage_const_1 )
                    
        self.reg_parents = [self._find(reg_c, i) for i in range(_sage_const_2 *self.n_seg)]
        
        # seg to region in the form (r_left, r_right), i. e. for each segment we record 
        # a region on the left and on the right
        self.seg_to_reg = {i:[self.reg_parents[_sage_const_2 *i], self.reg_parents[_sage_const_2 *i+_sage_const_1 ]] for i in range(self.n_seg)}
        ...
        self.reg_to_seg = {i:list(set([j//_sage_const_2  for j, r in enumerate(self.reg_parents) if r == i])) for i in self.noncirc_regions}
        ...
        for x in self.xs:
            if x.sign == _sage_const_1 :
                if (x, 'S') not in self.reg_to_xvs[self.seg_to_reg[x.i[_sage_const_0 ]][_sage_const_0 ]]:
                    self.reg_to_xvs[self.seg_to_reg[x.i[_sage_const_0 ]][_sage_const_0 ]].append((x,'S'))
                if (x, 'E') not in self.reg_to_xvs[self.seg_to_reg[x.i[_sage_const_0 ]][_sage_const_1 ]]:
                    self.reg_to_xvs[self.seg_to_reg[x.i[_sage_const_0 ]][_sage_const_1 ]].append((x,'E'))
                if (x, 'W') not in self.reg_to_xvs[self.seg_to_reg[x.k[_sage_const_0 ]][_sage_const_0 ]]:
                    self.reg_to_xvs[self.seg_to_reg[x.k[_sage_const_0 ]][_sage_const_0 ]].append((x,'W'))
                if (x, 'N') not in self.reg_to_xvs[self.seg_to_reg[x.k[_sage_const_0 ]][_sage_const_1 ]]:
                    self.reg_to_xvs[self.seg_to_reg[x.k[_sage_const_0 ]][_sage_const_1 ]].append((x,'N'))
            elif x.sign == -_sage_const_1 :
                if (x, 'W') not in self.reg_to_xvs[self.seg_to_reg[x.i[_sage_const_0 ]][_sage_const_0 ]]:
                    self.reg_to_xvs[self.seg_to_reg[x.i[_sage_const_0 ]][_sage_const_0 ]].append((x,'W'))
                if (x, 'S') not in self.reg_to_xvs[self.seg_to_reg[x.i[_sage_const_0 ]][_sage_const_1 ]]:
                    self.reg_to_xvs[self.seg_to_reg[x.i[_sage_const_0 ]][_sage_const_1 ]].append((x,'S'))
                if (x, 'N') not in self.reg_to_xvs[self.seg_to_reg[x.k[_sage_const_0 ]][_sage_const_0 ]]:
                    self.reg_to_xvs[self.seg_to_reg[x.k[_sage_const_0 ]][_sage_const_0 ]].append((x,'N'))
                if (x, 'E') not in self.reg_to_xvs[self.seg_to_reg[x.k[_sage_const_0 ]][_sage_const_1 ]]:
                    self.reg_to_xvs[self.seg_to_reg[x.k[_sage_const_0 ]][_sage_const_1 ]].append((x,'E'))
        for  v in self.vs:
            for s, _ in v.incoming:
                if (v, 'inc') not in self.reg_to_xvs[self.seg_to_reg[s][_sage_const_0 ]]:
                    self.reg_to_xvs[self.seg_to_reg[s][_sage_const_0 ]].append((v,'inc'))
            if (v, 'inc') not in self.reg_to_xvs[self.seg_to_reg[v.incoming[-_sage_const_1 ][_sage_const_0 ]][_sage_const_1 ]]:
                self.reg_to_xvs[self.seg_to_reg[v.incoming[-_sage_const_1 ][_sage_const_0 ]][_sage_const_1 ]].append((v,'inc'))
            
            if len(v.outgoing) > _sage_const_1 :
                for i in range(len(v.outgoing)-_sage_const_1 ):
                    s, _ = v.outgoing[i]
                    if (v, 'inc') not in self.reg_to_xvs[self.seg_to_reg[s][_sage_const_0 ]]:
                        self.reg_to_xvs[self.seg_to_reg[s][_sage_const_0 ]].append((v,'not inc'))
    ...
    def get_alexander_matrix(self):
        ...
        for j, (reg, adj_xvs) in enumerate(self.reg_to_xvs.items()):
            ...
            adj_xvs_elems_only = [e[_sage_const_0 ] for e in adj_xvs]
            for i, x in enumerate(self.xs):
                if x in adj_xvs_elems_only:
                    contrib = _sage_const_0 
                    # this covers the possibility of the same crossing being present multiple times 
                    # for the same region 
                    x_present = [e for e in adj_xvs if e[_sage_const_0 ] == x]
                    for x, pos in x_present:
                        x_type = '+' if x.sign == _sage_const_1  else '-'
                        # extract the color of a proper edge
                        col = self.seg_to_col[x.j[_sage_const_0 ]]
        ...
        for k, v in enumerate(self.vs):
            ...
            for s, col in v.incoming:
                left_region = list(self.reg_to_xvs.keys()).index(self.seg_to_reg[s][_sage_const_0 ])
                circ_region = k + len(self.reg_to_xvs.keys())
                right_region = list(self.reg_to_xvs.keys()).index(self.seg_to_reg[s][_sage_const_1 ])
    ...
    def get_state_sum(self, delta_segment = _sage_const_0 , left_region_index = _sage_const_0 ):
    ...
    def get_alexander_invariant(self, delta_segment = _sage_const_0 , left_region_index = _sage_const_0 ):
        ss = self.get_state_sum(delta_segment, left_region_index)
        denum = (self.t**(-_sage_const_1 /_sage_const_2 )- self.t**(_sage_const_1 /_sage_const_2 ))**(len(self.vs) - _sage_const_1 )
        return ss/denum

    def get_square_A(self, delta_segment = _sage_const_0 , left_region_index = _sage_const_0 ):
        n = left_region_index
        self.abs_delta = self.t**(n - self.seg_to_col[delta_segment]) - self.t**(n)  
    ...
    def A_Cp(self, xv_type, pos, color):
        if xv_type == 'circ':
            if pos == 'top':
                return self.t**(-color/_sage_const_2 ) - self.t**(color/_sage_const_2 )
            elif pos == 'left':
                return self.t**(-color/_sage_const_2 )
            elif pos == 'right':
                return self.t**(color/_sage_const_2 )
        elif xv_type == '+':
            if pos == 'N':
